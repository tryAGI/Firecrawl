...
internal static class CliRuntime
{
    ...
    public static async Task<global::Firecrawl.FirecrawlClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ...
            : new global::System.Collections.Generic.List<global::Firecrawl.EndPointAuthorization>
            {
        new global::Firecrawl.EndPointAuthorization
        {
            Type = "Http",
            SchemeId = "BearerAuth",
            Location = "Header",
    ...
    private static async Task WriteApiExceptionAsync(global::Firecrawl.ApiException exception)
    {
        var builder = new StringBuilder();
