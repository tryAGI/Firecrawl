...
namespace Firecrawl.Cli.GeneratedApi;

internal static class CliRuntime
{
    private const string UserSecretsId = "Firecrawl.Cli";
    private const string UserSecretApiKeyName = "FIRECRAWL_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"FIRECRAWL_API_KEY"];
    private const string CredentialFileDirectoryName = ".firecrawl";

    public static async global::System.Threading.Tasks.Task<global::Firecrawl.FirecrawlClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Firecrawl.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Firecrawl.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Firecrawl.FirecrawlClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Firecrawl.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Firecrawl.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Firecrawl.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Firecrawl.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("FIRECRAWL_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Firecrawl.ApiException exception)
    {
        var builder = new StringBuilder();
