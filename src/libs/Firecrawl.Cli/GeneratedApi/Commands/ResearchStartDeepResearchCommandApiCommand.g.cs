...
internal static class ResearchStartDeepResearchCommandApiCommand
{
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::Firecrawl.StartDeepResearchRequest>(
                            parseResult,
                            RequestJson,
                            RequestFile,
