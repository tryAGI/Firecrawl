...
namespace Firecrawl
{
    public partial class ExtractionClient
    {
        ...
        private static readonly global::Firecrawl.EndPointSecurityRequirement s_ExtractDataSecurityRequirement0 =
        ...
        private static readonly global::Firecrawl.EndPointSecurityRequirement[] s_ExtractDataSecurityRequirements =
            new global::Firecrawl.EndPointSecurityRequirement[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Firecrawl.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Firecrawl.AutoSDKHttpResponse<global::Firecrawl.ExtractResponse>> ExtractDataAsResponseAsync(
                ...
                else
                {
                    await global::Firecrawl.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Firecrawl.ApiException<global::Firecrawl.ExtractDataResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::Firecrawl.ApiException<global::Firecrawl.ExtractDataResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Firecrawl.ExtractResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Firecrawl.AutoSDKHttpResponse<global::Firecrawl.ExtractResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Firecrawl.ExtractResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
