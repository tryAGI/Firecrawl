...
namespace Firecrawl
{
    ...
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::System.DateTime?))]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::System.Guid?))]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::Firecrawl.GetLLMsTxtStatusResponseStatus?), TypeInfoPropertyName = "NullableGetLLMsTxtStatusResponseStatus2")]
    internal sealed partial class LLMsTxtSourceGenerationContextChunk0 : global::System.Text.Json.Serialization.JsonSerializerContext
    {
    }
    /// <summary>
    ///
    /// </summary>
    public sealed partial class LLMsTxtSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static LLMsTxtSourceGenerationContext Default { get; } = new(DefaultOptions);

        private LLMsTxtSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            ...
            {
                return
                    typeToConvert == typeof(global::Firecrawl.GetLLMsTxtStatusResponseStatus)
            ...
            {
                if (typeToConvert == typeof(global::Firecrawl.GetLLMsTxtStatusResponseStatus))
                {
                    return new global::Firecrawl.JsonConverters.GetLLMsTxtStatusResponseStatusJsonConverter();
                }

                if (typeToConvert == typeof(global::Firecrawl.GetLLMsTxtStatusResponseStatus?))
                {
                    return new global::Firecrawl.JsonConverters.GetLLMsTxtStatusResponseStatusNullableJsonConverter();
                }
        ...
        private sealed class LazyChunkResolver : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
        {
            ...
            private static global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver CreateResolver(int index)
            {
                return index switch
                {
                    0 => new LLMsTxtSourceGenerationContextChunk0(new global::System.Text.Json.JsonSerializerOptions()),
