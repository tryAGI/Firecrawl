...
namespace Firecrawl
{
    ...
    /// </summary>
    public sealed partial class ScrapeAndExtractFromUrlRequestLocation
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrapeAndExtractFromUrlRequestLocation" /> class.
        /// </summary>
        /// <param name="country">
        /// ISO 3166-1 alpha-2 country code (e.g., 'US', 'AU', 'DE', 'JP')<br/>
        /// Default Value: US
        ...
        public ScrapeAndExtractFromUrlRequestLocation(
            string? country,
