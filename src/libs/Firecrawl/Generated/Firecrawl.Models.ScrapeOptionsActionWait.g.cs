...
namespace Firecrawl
{
    ...
    public sealed partial class ScrapeOptionsActionWait
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Firecrawl.JsonConverters.ScrapeOptionsActionWaitTypeJsonConverter))]
        public global::Firecrawl.ScrapeOptionsActionWaitType Type { get; set; }
        ...
        public ScrapeOptionsActionWait(
            global::Firecrawl.ScrapeOptionsActionWaitType type,
            int? milliseconds,
            string? selector)
        {
            this.Type = type;
