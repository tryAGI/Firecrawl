...
namespace Firecrawl
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Firecrawl.AutoSDKRetryOptions Retry { get; set; } = new global::Firecrawl.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Firecrawl.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Firecrawl.IAutoSDKHook>();
        ...
        public global::Firecrawl.AutoSDKClientOptions AddHook(
            global::Firecrawl.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Firecrawl.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Firecrawl.AutoSDKClientOptions UseAuthorizationProvider(
            global::Firecrawl.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Firecrawl.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Firecrawl.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Firecrawl.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Firecrawl.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Firecrawl.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Firecrawl.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Firecrawl.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Firecrawl.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Firecrawl.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Firecrawl.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Firecrawl.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Firecrawl.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Firecrawl.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Firecrawl.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Firecrawl.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Firecrawl.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Firecrawl.AutoSDKClientOptions clientOptions,
            global::Firecrawl.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Firecrawl.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Firecrawl.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Firecrawl.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Firecrawl.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Firecrawl.IAutoSDKHook, global::Firecrawl.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Firecrawl.AutoSDKHookContext context)
        {
